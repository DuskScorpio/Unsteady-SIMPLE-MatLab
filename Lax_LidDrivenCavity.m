...
numCellsY = 129; % number of cells along the y-direction
...
%% Ghia et al. (1982) benchmark values
...
% Re= 100, 400, 1000, 3200, 500, 7500, 10000
ghia_u = [
...
-0.21090 -0.17119 -0.10648 -0.86636 -0.07404 -0.07503 -0.07540;
...
ghia_x = [1.00000, 0.9688, 0.9609, 0.9531, 0.9453, 0.9063, 0.8594, 0.8047, ...
...
-0.16914 -0.23827 -0.51500 -0.44307 -0.41442 -0.41050 -0.41496;
...
plot(ghia_u(:, plotRe), ghia_y, 'o'); % Re=100
axis equal;
xlabel('u');
ylabel('y');
...
plot(ghia_x, ghia_v(:, plotRe), 'o'); % Re=100
xlabel('x');
ylabel('v');
legend('SIMPLE','Ghia et al.');
...
exportgraphics(figure(1), fullfile(resultsFolder, filePrefix + "Velocity_Magnitude.png"), 'Resolution', 300, 'BackgroundColor', 'white');
exportgraphics(figure(2), fullfile(resultsFolder, filePrefix + "u_Velocity.png"), 'Resolution', 300, 'BackgroundColor', 'white');
exportgraphics(figure(3), fullfile(resultsFolder, filePrefix + "v_Velocity.png"), 'Resolution', 300, 'BackgroundColor', 'white');
exportgraphics(figure(4), fullfile(resultsFolder, filePrefix + "Pressure.png"), 'Resolution', 300, 'BackgroundColor', 'white');
exportgraphics(figure(5), fullfile(resultsFolder, filePrefix + "u_Centerline.png"), 'Resolution', 300, 'BackgroundColor', 'white');
exportgraphics(figure(6), fullfile(resultsFolder, filePrefix + "v_Centerline.png"), 'Resolution', 300, 'BackgroundColor', 'white');